...
- `count_assignments.py` — base definitions and interfaces (provided)
- `count_assignments_solution.py` — full logic implementation with unit tests
- `README.md` — this explanation

## 🚀 Features

- Works with all types of hints
- Efficient for small CSPs (5! × 5!)
